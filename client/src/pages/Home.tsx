  ...
  return (
    <main className="site-shell">
      ...
      <section className="hero" id="atelier">
        ...
        <div className="hero-art"><img src={HERO_IMAGE} alt="Composition éditoriale autour d’une image et d’une grille de pixels" /><div className="art-label">FIG. A — IMAGE PORTEUSE</div></div>
      </section>
