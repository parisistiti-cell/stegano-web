...
import { Check, Download, Eye, EyeOff, FileImage, LockKeyhole, Moon, ScanLine, Sun, Upload, WandSparkles } from "lucide-react";
          ...
          <div className="workspace-grid">
            ...
            <div className="operation-column">
              {mode === "encode" ? <>
                ...
                <textarea id="decoded-message" className="decoded-message-area" value={decodedMessage} readOnly placeholder="Le message décodé apparaîtra ici…" rows={16} />
